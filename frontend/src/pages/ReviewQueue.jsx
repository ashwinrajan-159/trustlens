      ...
      <Card>
        {loading ? <Spinner /> : items.length ? (
          <table className="w-full text-sm">
            <thead className="text-left text-xs uppercase text-slate-400"><tr><th className="py-2">Number</th><th>Type</th><th>Amount</th><th>Status</th><th>Risk</th><th>Submitted</th><th></th></tr></thead>
